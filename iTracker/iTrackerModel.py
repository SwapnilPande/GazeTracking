...
from keras.layers import Input, Dense, Conv2D, MaxPooling2D, Concatenate, Reshape, ZeroPadding2D,Activation
...
def createConvLayer(filters, kernelSize, stride,activation = 'relu'):
        return Conv2D(
                filters,
                kernelSize,
                strides = stride,
...
def initializeModel():
        ...
        convE1 = createConvLayer(96, 11, 4,activation ='linear')
        ...
        convF1 = createConvLayer(96, 11, 4,'linear')
        ...
        leftDataBNE1 = BNE1(leftDataConvE1)
        leftAct1   = ReluActivation(leftDataBNE1)
        leftDataMaxPoolE1 = maxPoolE1(leftAct1)
        ...
        rightDataBNE1 = BNE1(rightDataConvE1)
        rightAct1   = ReluActivation(rightDataBNE1)
        rightDataMaxPoolE1 = maxPoolE1(rightAct1)
        ...
        dataBNF1 = BNF1(dataConvF1)
        act1   = ReluActivation(dataBNF1)
        dataMaxPoolF1 = maxPoolF1(act1)
